    ...
    <div class="page-content">
        <div class="page-header">
            <div class="container-fluid">
                <h2 class="mb-4">Add New Tenant</h2>

                <!-- Tenant Form -->
                <div class="card shadow-sm p-4">
                    <form action="{{ url('upload_tenant') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="national_id" placeholder="Enter tenant ID number">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control" name="rent" placeholder="e.g. 15000" required>
                            </div>

                            <div class="col-md-4">
                                <label for="utilities" class="form-label">Utilities (Ksh)</label>
                                <input type="number" step="0.01" class="form-control" name="utilities" placeholder="e.g. 1000">
                            </div>

                            <div class="col-md-4">
                                <label for="security_deposit" class="form-label">Security Deposit (Ksh)</label>
                                <input type="number" step="0.01" class="form-control" name="security_deposit" placeholder="e.g. 5000">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="emergency_contact_phone" placeholder="e.g. 0712345678">
                            </div>
                        </div>

                        <div class="text-end mt-4">
                            <button type="submit" class="btn btn-primary">Save Tenant</button>
                            <a href="{{ url('upload_tenant') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
