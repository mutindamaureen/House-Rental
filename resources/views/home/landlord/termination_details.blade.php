...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="status-timeline">
                            ...
                            <div class="timeline-item">
                                ...
                                <div>
                                    <h6 class="mb-1">Tenant Signature</h6>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        @if($contract->tenant->phone)
                            <p><strong>Phone:</strong> {{ $contract->tenant->phone }}</p>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <!-- Signature Pad -->
            <div class="col-lg-7">
                @if(!$contract->landlord_termination_signature && $contract->termination_status !== 'completed')
                    <div class="card shadow-sm">
                        <div class="card-header bg-danger text-white">
                        ...
                        <div class="card-body">
                            ...
                            <form id="signatureForm" action="{{ route('landlord.termination.sign', $contract->id) }}" method="POST">
                                @csrf
